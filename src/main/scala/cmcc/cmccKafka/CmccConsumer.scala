...
import cmcc.utils.{ConfUtil, Jpools}
...
object CmccConsumer {
  def main(args: Array[String]): Unit = {
    ...
    val conf: SparkConf = new SparkConf().setAppName("cmcc").setMaster("local[*]")
    ...
    var stream: InputDStream[ConsumerRecord[String, String]] = KafkaUtils.createDirectStream(ssc,
